			...
			<ul class="list-group groove-border-wrapper" component="user/sessions">
				...
				<li class="list-group-item" data-uuid="{../uuid}">
					<div class="pull-right">
						...
						<!-- IF !../current -->
						<div class="groove-border-wrapper btn-wrapper"><button class="btn btn-xs btn-default" type="button" data-action="revokeSession">Revoke Session</button></div>
						<!-- ENDIF !../current -->
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							...
							<!-- IF !banned -->
							<!-- IF !isSelf -->
							<div class="groove-border-wrapper btn-wrapper"><button class="btn btn-xs pull-right btn-danger" component="account/ban">[[user:ban_account]]</button></div>
							<!-- ENDIF !isSelf -->
							<!-- ELSE -->
							<!-- IF !isSelf -->
							<div class="groove-border-wrapper btn-wrapper"><button class="btn btn-xs pull-right btn-success" component="account/unban">[[user:unban_account]]</button></div>
							<!-- ENDIF !isSelf -->
							<!-- ENDIF !banned -->
						</h3>
					</div>
