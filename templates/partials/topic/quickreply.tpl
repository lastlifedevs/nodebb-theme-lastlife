...
<div class="clearfix quick-reply">
	...
	<form method="post" action="{config.relative_path}/compose">
		...
		<div class="groove-border-wrapper btn-wrapper"><button type="submit" component="topic/quickreply/button" class="btn btn-primary pull-right">[[persona:post-quick-reply]]</button></div>
	</form>
</div>
