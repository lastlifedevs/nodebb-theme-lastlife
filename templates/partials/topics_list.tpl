<div class="category topics-container col-lg-12">
    <ul component="category" class="topic-list" itemscope itemtype="http://www.schema.org/ItemList" data-nextstart="{nextStart}" data-set="{set}">
        <meta itemprop="itemListOrder" content="descending">
        <!-- BEGIN topics -->
        <li component="category/topic" class="row clearfix category-item topic-row {function.generateTopicClass}" <!-- IMPORT partials/data/category.tpl -->>
            <meta itemprop="name" content="{function.stripTags, title}">

            <div class="col-md-7 col-sm-9 col-xs-10 content topic-info">
            ...
            <div class="col-md-3 col-sm-3 teaser hidden-xs" component="topic/teaser">
                <div class="card" style="border-color: {topics.category.bgColor}">
                    ...
                    <div>
                        <p>
                            <a href="{config.relative_path}/user/{topics.teaser.user.userslug}" title="{topics.teaser.user.username}">
                                <!-- IF topics.teaser.user.fullname -->{topics.teaser.user.fullname}<!-- ELSE -->{topics.teaser.user.username}<!-- ENDIF topics.teaser.user.fullname -->
                            </a>
                        </p>
                        <p>
                            <a class="permalink" href="{config.relative_path}/topic/{topics.slug}/{topics.teaser.index}">
                                <span class="timeago" title="{../teaser.timestampISO}"></span> <i class="fa fa-chevron-circle-right"></i>
                            </a>
                        </p>
                    </div>
