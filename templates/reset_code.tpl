...
<div class="well-wrapper groove-border-wrapper">
	<div class="well">
		...
		<form onsubmit="return false;" id="reset-form" class="row">
			...
			<div class="col-xs-12">
				<div class="groove-border-wrapper btn-wrapper btn-wrapper-block"><button class="btn btn-primary btn-block" id="reset" type="submit">[[reset_password:reset_password]]</button></div>
			</div>
		</form>
	</div>
</div>
